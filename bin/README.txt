...
2. Doctor --> clasa in care sunt retinute datele doctorilor si metodele lor;
	  --> Metode:
		a) canCure - decide daca doctorul poate trata sau nu o anumita
			     afectiune;
		b) cure - doctorul consulta pacientul;
		...
		c) consult - doctorul verifica daca unul din pacientii internati
			     de el si-a terminat tratamentul sau daca i-as scazut
			     severitatea la 0 si poate fi trimis acasa sau nu;
		d) operate - doctorul opereaza pacientul, ii calculeaza noua
			     severitate si il spitalizeaza;
		e) hospitalize - doctorul ii calculeaza pacientului numarul de runde
...
3. ERTechnician --> clasa in care sunt retinute datele investigatorilor si metodele;
		--> Metode:
			a) examinate - investigatorul ii face pacientului analize
...
4. Nurse --> clasa in care sunt retinute datele asistentelor si metodele lor:
	 --> Metode:
		a) calculateUrgency - calculeaza gradul de urgenta al unui pacient
				      din Triage Queue;
		b) treatPatients - administreaza tratamentul tuturor pacientilor
